...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    $query = "SELECT art.cve_articulo, art.id_marca, art.sku, art.nombre, art.concentracion, art.presentacion, art.sabor, 
                     art.descripcion_corta, art.descripcion_larga, art.precio, art.precio_con_descuento, art.inventario_cantidad, art.orden, art.id_categoria_articulo, art.id_subcategoria_articulo, 
                     art.ban_activo, cma.nombre AS marca, cca.nombre AS categoria, csa.nombre as subcategoria
